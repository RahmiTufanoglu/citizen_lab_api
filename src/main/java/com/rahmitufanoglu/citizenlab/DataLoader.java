...
public class DataLoader implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) {
    ...
    if (users.isEmpty()) {
      ...
      authorities.add(new Authority("ADMIN", user1));
      authorities.add(new Authority("ADMIN", user2));
      authorities.add(new Authority("ADMIN", user3));*/

      User user1 = new User("Rahmi", "Tufanoglu", "rahmi@gmail.com", "rahmi123", "rahmi123", LocalDateTime.now(), LocalDateTime.now(),
          projectList);
      User user2 = new User("Umut", "Tufanoglu", "umut@gmail.com", "rahmi123", "rahmi123", LocalDateTime.now(), LocalDateTime.now(),
          projectList);
      User user3 = new User("Dilan", "Tufanoglu", "dilan@gmail.com", "rahmi123", "rahmi123", LocalDateTime.now(), LocalDateTime.now(),
          projectList);
